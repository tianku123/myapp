export default {
  ...
  'menu.list.redisgroup': '分组列表',
  'menu.list.redisip': 'IP列表',
  'menu.list.redismonitor': 'Redis监控列表',
  'menu.dashboard.redisgroup': '分组列表',
  'menu.dashboard.redisip': 'IP列表',
  'menu.dashboard.redismonitor': 'Redis监控列表',
